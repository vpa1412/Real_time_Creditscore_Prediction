...
#
# Load the dataset
df = spark.read.csv('/home/phuonganh/CS411//finalproject/finalbigdata/final_bigdata/train.csv', header=True, inferSchema=True)
...
sc = SparkContext("spark://192.168.80.84:7077", "ktinh")
# df = sc.textFile('hdfs://192.168.80.65:9000/home/phuonganh/CS411/sample1.txt')
sc.setLogLevel("ERROR")
df.saveAsTextFile("hdfs://192.168.80.84:9000/vpa2003/training.csv")
