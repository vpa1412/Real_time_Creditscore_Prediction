...
spark = SparkSession.builder \
    .appName("CreditDataTest") \
    .getOrCreate()

# Load the dataset
df = spark.read.csv('/home/phuonganh/CS411/final_bigdata/test.csv', header=True, inferSchema=True)

# Drop unwanted columns
df = df.drop("Customer_ID", "Month", "Name", "SSN", "Type_of_Loan", "Credit_Mix", "Credit_Score")
...
output_path = "~/CS411/final_bigdata/testing.csv"
#
